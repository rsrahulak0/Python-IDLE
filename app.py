...
#button
Open = PhotoImage(file="resources/open.png")
Save = PhotoImage(file="resources/save.png")
Run = PhotoImage(file="resources/run.png")

Button(root, image=Open, bg="#323486", bd=0, command=open_file).place(x=30, y=30)
Button(root, image=Save, bg="#323486", bd=0, command=save).place(x=30, y=145)
Button(root, image=Run, bg="#323486", bd=0, command=run).place(x=30, y=260)
